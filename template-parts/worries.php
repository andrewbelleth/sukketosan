            ...
            <div class="worries__inner wrapper">
                <ul class="worries__list">
                    <li class="worries__item">
                        専門スタッフが<span class="worries__item-color">急に休職…</span>復職までどう乗り切る？</span>
                    </li>
                    <li class="worries__item">
                        正社員を雇う余裕なし。でも<span class="worries__item-color">アルバイト</span>では戦力不足…
                    </li>
                    <li class="worries__item">
                        外注すると管理もコミュニケーションも<span class="worries__item-color">大変すぎる…</span>
                    </li>
                    <li class="worries__item">
                        社内で人材を育成できない。でも<span class="worries__item-color">今すぐプロが必要！</span>
                    </li>
                </ul>
            </div>
        </div>
